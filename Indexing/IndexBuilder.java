...
public class IndexBuilder {
    ...
    public void writeTermAndIdMaptoDisk() {
        ...
        String termIdToTermFilePath = "termIdToTermMap.txt";

        try {
            File termIdToTermFile = new File(termIdToTermFilePath);
            FileOutputStream fos = new FileOutputStream(termIdToTermFile);
            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(fos));

            for (Integer id : termIdtoTermMap.keySet()) {
                String s = id + "," + termIdtoTermMap.get(id);
                bw.write(s);
                bw.newLine();
            }
            bw.close();
            ...
            FileOutputStream fos2 = new FileOutputStream(termToTermIdFile);
